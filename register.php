        ...
        <div class="col-md-6 right" data-aos="fade-left" data-aos-duration="1000">
            ...
            <form method="POST">
                <div class="form-group" data-aos="fade-up" data-aos-delay="300">
                    <input type="nama" name="nama" placeholder="Nama" class="form-control" required>
                </div>
                ...
                <button type="submit" name="register" class="btn submit-btn"  data-aos-delay="500">submit</button>
            </form>

            <a href="index.php">
                <div class="create-account" data-aos="fade-up" data-aos-delay="600">Login di sini</div>
            </a>
        </div>
    </div>
</div>
